...
$\mathrm{SINR}_{k}(\widehat{\mathbf{H}})=\frac{\bigl|\mathbf{w}_k^{\mathsf{H}}\mathbf{h}_k\bigr|^2}{\sum_{j\neq k}\bigl|\mathbf{w}_k^{\mathsf{H}}\mathbf{h}_j\bigr|^2+\frac{N_{\mathrm{t}}}{\rho}\,\|\mathbf{w}_k\|^2}.$
